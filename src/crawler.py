...
def main():
    ...
    # POST EXAMPLE
    # post = Post("www.google.com", "8.8.8.8", datetime.utcnow(), "0", "{}", "TRUE", "TRUE", "TRUE", None)
    # post.save_to_mongo()

    # QUERY EXAMPLE
    # content = Search.from_mongo("7c1980009a234c42b80a52801f6a60f7")
    # print(content)

    # CERTIFICATE COUNT EXAMPLE
    # number = Search.certificate_count("TRUE")
